...
from env_utils import MINIMAX_API_KEY, MINIMAX_BASE_URL, TONGYI_API_KEY, TONGYI_BASE_URL
...
llm_tongyi = ChatTongyi(model="qwen3.5-plus", temperature=0.7, api_key=TONGYI_API_KEY)
